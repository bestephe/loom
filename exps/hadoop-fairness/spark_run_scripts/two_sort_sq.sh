...
do
    ...
    sudo tcpdump -i eno2 -w /dev/shm/spark_tcp_flows.pcap -s 64 src 10.10.1.2 or src 10.10.101.2 or src 10.10.102.2 &
    ...
    ./pcap_flows/get_job_tput_ts.py --pcap /dev/shm/spark_tcp_flows.pcap --outf results/tputs_two_sort_sq.$i.yaml

    rm tmp_sort1.out
    rm tmp_sort2.out
    rm -f /dev/shm/spark_tcp_flows.pcap
done
